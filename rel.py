...
def get_ip_information(ip):
    ...
    is_malicious_virustotal = False  # Initialize with a default value
    engines_detected = 0  # Initialize with a default value
...
def main():
    input_csv_file = "sample2.csv"  # Replace with your CSV file path
    output_csv_file = "results.csv"  # Replace with desired output CSV file path
